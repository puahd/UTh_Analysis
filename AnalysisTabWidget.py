...
class AnalysisTabWidget(QWidget):
    ...
    def initSettingsBox(self):
        ...
        metadataHistoryGrid.addItem(QSpacerItem(0, 0, QSizePolicy.Minimum, QSizePolicy.Expanding), 2, 0, 1, 1)
    ...
    def initResultsBox(self):
        ...
        self.resultTable.setVerticalScrollMode(QAbstractItemView.ScrollPerPixel)
        self.resultTable.setHorizontalScrollMode(QAbstractItemView.ScrollPerPixel)
