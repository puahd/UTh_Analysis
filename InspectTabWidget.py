...
from PyQt5.QtWidgets import QWidget, QGroupBox, QGridLayout, QListWidget, QListWidgetItem, QLabel, QComboBox, \
    QPushButton, QTableView, QHeaderView, QAbstractItemView, QSpacerItem, QSizePolicy
...
class InspectTabWidget(QWidget):
    ...
    def initVisualizeBox(self):
        ...
        optionsLayout.addItem(QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding), 4, 0, 1, 2)
