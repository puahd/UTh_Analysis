...
class RatioBuilder:
    ...
    def calc_blank_correction(self):
        old_path = os.getcwd()
        folder_blank = os.path.join(self.data_root_folder, 'blank')
        ...
        if self.blk == 1.0:
            ...
            blank = pd.DataFrame(
                ...
                index=names_blank)
            writer = ExcelWriter(os.path.join(self.data_root_folder,'PrBlank.xlsx'), engine='xlsxwriter')            
    ...
    def data_correction(self):
        ...
        writer = ExcelWriter(os.path.join(self.data_root_folder,'Ratios.xlsx'), engine='xlsxwriter')            
        ...
        writer = ExcelWriter(os.path.join(self.data_root_folder,'Ratios_add.xlsx'), engine='xlsxwriter')            
        ...
        writer = ExcelWriter(os.path.join(self.data_root_folder,'Tailing.xlsx'), engine='xlsxwriter')            
        ...
        writer = ExcelWriter(os.path.join(self.data_root_folder,'Intensities.xlsx'), engine='xlsxwriter')            
